 ...
 */
package org.geoserver.dcs.geopkg;
...
import org.geoserver.enc.geopkg.EncryptedGeoPackage;
import org.geoserver.enc.geopkg.GeoPackageGetFeatureOutputFormat;
...
public class GeoPackageGetFeatureOutputFormatTest extends WFSTestSupport {
    ...
    public void testHttpStuff() throws Exception {
        ...
        assertEquals(EncryptedGeoPackage.MIME_TYPE, resp.getContentType());
